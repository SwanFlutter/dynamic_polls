...
class OptionStyle {
  ...
  /// The icon displayed before the option text when it is selected.
  /// Defaults to a check circle icon. Set to null to hide.
  final Widget? selectedIcon;

  /// The icon displayed before the option text when it is not selected.
  /// Defaults to a circle outline icon. Set to null to hide.
  final Widget? unselectedIcon;

  /// The color of the selectedIcon / unselectedIcon.
  /// If null, falls back to [selectedBorderColor] or [textSelectColor].
