  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            if (widget.isSelected && optionStyle?.selectedIcon != null)
              optionStyle!.selectedIcon!
            else if (!widget.isSelected && optionStyle?.unselectedIcon != null)
              optionStyle!.unselectedIcon!
            else
              Icon(
                widget.isSelected
