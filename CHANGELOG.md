...
### 🔧 Improvements
- **BREAKING**: Replaced `get_x_storage` with `shared_preferences` for full cross-platform compatibility
- Fixed platform compatibility issues (Android, iOS, Windows, Linux, macOS, Web)
...
* Add `PollStorage` for local vote persistence using local storage
